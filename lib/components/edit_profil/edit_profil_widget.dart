...
class EditProfilWidget extends StatefulWidget {
  ...
  final DocumentReference? detailUser;
...
class _EditProfilWidgetState extends State<EditProfilWidget>
  ...
  void initState() {
    ...
    _model.nomCompletFocusNode ??= FocusNode();
                      ...
                      Form(
                        ...
                        child: Padding(
                          ...
                          child: StreamBuilder<UsersRecord>(
                            stream:
                                UsersRecord.getDocument(widget.detailUser!),
                                      ...
                                      children: [
                                        Expanded(
                                          child: Padding(
                                            ...
                                            child: TextFormField(
                                              controller: _model
                                                      .nomCompletTextController ??=
                                                  TextEditingController(
                                                text: columnUsersRecord
                                                    .displayName,
                                              ),
                                              focusNode:
                                                  _model.nomCompletFocusNode,
                                              autofocus: true,
                                              obscureText: false,
                                              ...
                                              validator: _model
                                                  .nomCompletTextControllerValidator
                                                  .asValidator(context),
                                            ),
                                          ),
                                        ),
