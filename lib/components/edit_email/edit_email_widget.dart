...
class _EditEmailWidgetState extends State<EditEmailWidget>
  ...
  void initState() {
    ...
    _model.mdpTextController ??= TextEditingController();
                                    ...
                                    Expanded(
                                      child: Padding(
                                        padding: EdgeInsetsDirectional.fromSTEB(
                                            0.0, 0.0, 0.0, 12.0),
                                        child: TextFormField(
                                          controller: _model.mdpTextController,
                                          ...
                                          child: FFButtonWidget(
                                            onPressed: () async {
                                              _model.reponse =
                                                ...
                                                _model.mdpTextController.text,
                                              );
                                              if (_model.reponse == true) {
                                                ...
                                                ScaffoldMessenger.of(context)
                                                  ...
                                                  SnackBar(
                                                    content: Text(
                                                      'Votre email a été modifier avec succès! un lien a été envoyer à l\'adresse ${_model.emailTextController.text}',
                                                      style: TextStyle(
                                                        color:
                                                            FlutterFlowTheme.of(
                                                                    context)
